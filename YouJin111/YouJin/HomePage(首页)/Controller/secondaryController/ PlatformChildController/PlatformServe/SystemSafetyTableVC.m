...
@implementation SystemSafetyTableVC
#pragma mark - 懒加载
...
- (void)setupNavigationItem {
    ...
    // 设置标题
    BOSetupTitleView *titleView = [BOSetupTitleView setupTitleViewTitle:@"系统安全"];
