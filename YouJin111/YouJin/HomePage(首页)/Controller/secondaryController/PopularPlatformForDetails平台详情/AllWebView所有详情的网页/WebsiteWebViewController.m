//
//  WebsiteWebViewController.m
//  YouJin
//
//  Created by 柚今科技01 on 2017/4/20.
//  Copyright © 2017年 youjin. All rights reserved.
//

#import "WebsiteWebViewController.h"

@interface WebsiteWebViewController ()<UIWebViewDelegate>

@end

@implementation WebsiteWebViewController
- (void)viewWillAppear:(BOOL)animated
{
    ...
    self.navigationItem.titleView = [BOSetupTitleView setupTitleViewTitle:@"官网"];
