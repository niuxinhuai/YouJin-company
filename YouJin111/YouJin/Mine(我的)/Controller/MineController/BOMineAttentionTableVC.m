...
@interface BOMineAttentionTableVC ()

@end

@implementation BOMineAttentionTableVC
- (void)dealloc {
    NSLog(@"BOMineAttentionTableVC");
}
- (void)viewDidLoad {
    [super viewDidLoad];
    // 注册cell
...
- (void)viewWillAppear:(BOOL)animated {
    ...
    BOSetupTitleView *titleView = [BOSetupTitleView setupTitleViewTitle:@"关注(10)"];
