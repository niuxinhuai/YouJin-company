...
- (void)_commonInit
{
    ...
    UIImage *backspaceImage = [self.class _keyboardImageNamed:@"icon_huishan"];
    UIImage *dismissImage = [self.class _keyboardImageNamed:@"icon_shouqi"];
...
{
    return UIKitLocalizedString(@"完成");
}
